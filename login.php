...
<head>
    ...
    <title>LOGIN | Auto Spare Part Management System</title>
    ...
    <style>
        ...
        body{
            background-image:url('./images/auto2.jpg') !important;
...
<body class="">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center text-light px-4" id="sys_title">Auto Spare Part Management System</h1>
